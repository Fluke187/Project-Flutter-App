...
class Re2 extends StatefulWidget {
  ...
  String Password = "";
  String Email = "";
  Re2 ({super.key,this.Username="",this.Password="",this.Email=""}){
...
class _Re2State extends State<Re2> {
  ...
  String get _formattedDate {
    if (_pregnancyDate == null) {
      return 'กรุณากรอกวันที่ตั้งครรภ์';
    } else {
  ...
  Future<void> _validateAndSubmit() async {
    ...
    var responsedata = await apiService.register(username, password, Email,double.parse(_weightController.text),double.parse(_heightController.text), _pregnancyDate );
              ...
              InkWell(
                ...
                child: InputDecorator(
                  decoration: InputDecoration(
                    ...
                    contentPadding: EdgeInsets.symmetric(vertical: 10, horizontal: 10.0), // ปรับขนาดพื้นที่ภายใน
                  ),
                  child: Row(
